...
let ResturantService = class ResturantService {
    ...
    updateResturant({ id, data }) {
        return this.resturants.update(id, Object.assign({}, data));
    }
};
ResturantService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(resturant_entity_1.Resturant)),
